...
ComboBox3.Text:=ZQuery1.FieldList[6].AsString;
...
//simpan
ZQuery1.SQL.Clear;
ZQuery1.SQL.Add('insert into detail_jual values (null,"'+ComboBox1.Text+'","'+ComboBox2.Text+'","'+Edit1.Text+'","'+Edit2.Text+'","'+Edit3.Text+'","'+ComboBox3.Text+'")');
ZQuery1.ExecSQL;
...
if  (ComboBox1.Text = ZQuery1.Fields[1].AsString) and  (ComboBox2.Text = ZQuery1.Fields[2].AsString) and  (Edit1.Text = ZQuery1.Fields[3].AsString) and (Edit2.Text = ZQuery1.Fields[4].AsString) and (Edit3.Text = ZQuery1.Fields[5].AsString) and (ComboBox3.Text = ZQuery1.Fields[6].AsString) then
begin
...
ZQuery1.SQL.Clear;
ZQuery1.SQL.Add('update detail_jual set penjualan_id="'+ComboBox1.Text+'",barang_id="'+ComboBox2.Text+'",qty="'+Edit1.Text+'",harga_jual="'+Edit2.Text+'",total_jual="'+Edit3.Text+'",status="'+ComboBox3.Text+'" where id="'+id+'"');
ZQuery1.ExecSQL;
